import 'package:chat/app/data/models/chat_message.dart';
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: itsMe
              ? Color.fromRGBO(90, 185, 234,
                  1) //цвет фона сообщения для текущего пользователя
              : Color.fromRGBO(86, 128, 233,
                  1), //цвет фона сообщения для другого пользователя
        ),
        child: Column(
          crossAxisAlignment:
